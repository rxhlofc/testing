...
from rich import print as Miku
from rich.panel import Panel as Nel
from rich.panel import Panel as Gacor
...
class MAIN:
   ...
   def Me(self):
       Miku(Gacor(f'''[bold green]
 _ _______________   _____ _____ ____ _   _     Pr4mhax0r
/ |___ /___ /___  | |_   _| ____/ ___| | | |    ManzGans
| | |_ \ |_ \  / /    | | |  _|| |   | |_| |    Sam404
| |___) |__) |/ /     | | | |__| |___|  _  |    PxM0759
|_|____/____//_/      |_| |_____\____|_| |_|    DedsecV2
''',title=f"[bold white][[bold green]MANZ-STEVIA[bold white]]",style=f"bold red"))
   ...
   def insta(self):
       ...
       self.Os = True
       if self.Os is True:
          self.username = 'MANZ STEVIA'
          self.join     = '{datenow}'
          self.expired  = '1-1-1001'
          self.status   = 'ADMIN'
       else:
