...
- Mainkan Mode Pesawat Jika Proses Cepat 400 ID Slow 200 -')
 ...
 Facebook acc : {akunfb}
 cookie       : {cookie}""",title=f"[bold white][[bold green]MANZ-OK[bold white]]",style=f"bold green"))
                    else:
 ...
 [bold green]cookie       : [bold green]{cookie}""",title=f"[bold white][[bold green]MANZ-OK[bold white]]",style=f"bold green"))
                       self.aut = None
                       self.pem = None
                       self.PWX = pwb
